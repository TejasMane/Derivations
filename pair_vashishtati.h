...
PairStyle(vashishtati,PairVashishtati)

#else

#ifndef LMP_PAIR_VASHISHITATI_H
#define LMP_PAIR_VASHISHITATI_H

#include "pair.h"

namespace LAMMPS_NS {

class PairVashishtati : public Pair {
 public:
  PairVashishtati(class LAMMPS *);
  virtual ~PairVashishtati();
 ...
 private:
  ...
  bigint t1; // Final time till the TI method is performed.
